...
class BasebandSignal:
    ...
    must be centered on zero frequency). Time is axis 0, the rest is the
    sample shape. The first axis of sample shape (axis 1) is frequency,
    representing channels or bands.
    """
